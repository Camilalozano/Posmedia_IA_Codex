...
def main():
    st.set_page_config(page_title='Prediligenciamiento del Informe de ejecución y supervisión', page_icon='📄', layout='wide')
    st.title('Prediligenciamiento del Informe de ejecución y supervisión')
