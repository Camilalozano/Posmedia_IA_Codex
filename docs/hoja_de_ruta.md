...
2. Implementado: conexión al CSV remoto de Oracle mediante `ORACLE_PAR_URL`, reemplazo temporal del PAR desde un campo protegido y mensajes seguros para renovarlo. Pendiente: supervisar vencimiento y definir un mecanismo estable sin PAR.
