...
2. Pulse **Consultar proceso** para buscar en Oracle. Si falla la conexión, ingrese el enlace nuevo en **Actualizar ruta PAR al archivo** y consulte otra vez. Cuando SECOP informa los identificadores necesarios, puede abrir el proceso, descargar la minuta oficial, la ficha PDF y el ZIP con todos los documentos asociados, y revisar su inventario y las tablas extraídas de la minuta.
3. Si dispone de ellas, cargue las evidencias PDF individualmente o dentro de un ZIP. También puede cargar por separado el **Informe SICORE** y la **Planilla Seguridad Social**, ambos en PDF. Los tres cargadores son opcionales y sus documentos aparecen en el inventario de evidencias. Límite conjunto: 50 PDF, 20 MB por PDF y 100 MB descomprimidos en total. No se admiten ZIP cifrados, ZIP anidados ni otros formatos.
